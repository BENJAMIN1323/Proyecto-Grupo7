...
public class Evaluacion {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "estado")
    private VerificacionEvaluacion estado;
    ...
    public Evaluacion() {
        super();
        estado = VerificacionEvaluacion.PENDIENTE;
        nota = 0;
    }

    public Evaluacion(Empresa empresa, Usuario evaluador, Anexo tipo, LocalDateTime fecha, PromedioGeneral promedioGeneral) {
        super();
    ...
    public Evaluacion(Anexo tipoEvaluacion2, Usuario usuario, Usuario evaluador2) {
    }
    ...
    public VerificacionEvaluacion getEstado() {
        return estado;
    }
    ...
    public void setEstado(VerificacionEvaluacion estado) {
        this.estado = estado;
    }
    ...
    public void aprobar() {
        estado = VerificacionEvaluacion.APROBADA;
    }

    public void desaprobar() {
        estado = VerificacionEvaluacion.DESAPROBADA;
    }
